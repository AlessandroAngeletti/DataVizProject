...
# Referring to wine classifications from 
# https://winefolly.com/deep-dive/different-types-of-wine/ , let's clean the
# 'variety' into bigger aggregate groupings
...
characteristics_variety4 <- characteristics_variety3 %>%
  mutate(wine_type = factor(wine_type, levels = c("Dry Red", "Dry White",
                                                  "Sweet White", "Rosé", "Sparkling Wine"))) %>% 
